...
const tryGetEvents = async (start, end, symbol) => {
  try {
    ...
    // const pastEventsDeposit = await Contract.getPastEvents("Deposit", { fromBlock: start, toBlock: end });
    // const pastEventsWitdraw = await Contract.getPastEvents("Withdraw", { fromBlock: start, toBlock: end });
    // const pastEvents = pastEventsDeposit.concat(pastEventsWitdraw);
